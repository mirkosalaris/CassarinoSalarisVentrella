...
\subsection{Functional Requirements}
	...
	\bigskip
	\noindent\myref{G-become-registered}
	...
	\bigskip
	\noindent\myref{G-use-credit-card}
	\begin{enumerate}[resume, label={[R\arabic*]}]
	...
	\bigskip
	\noindent\myref{G-pers-preferences}
	\begin{enumerate}[resume, label={[R\arabic*]}]
	...
	\bigskip
	\noindent\myref{G-new-appointment}
	\begin{enumerate}[resume, label={[R\arabic*]}]
	...
	\bigskip
	\noindent\myref{G-visualize-update}
	\begin{enumerate}[resume, label={[R\arabic*]}]
	...
	\bigskip
	\noindent\myref{G-choose-sug} \textbf{and} \myref{G-change-preferred-transp}
	\begin{enumerate}[resume, label={[R\arabic*]}]
	...
	\bigskip
	\noindent\myref{G-visualize-schedule}
	\begin{enumerate}[resume, label={[R\arabic*]}]
	...
	\bigskip
	\noindent\myref{G-show-suggestions}
	\begin{enumerate}[resume, label={[R\arabic*]}]
