\subsection{External Interface Requirements}
	\subsubsection{User Interfaces}
		...
		\end{figure}	
		\begin{figure}[H]
			\centerline{\includegraphics[scale=0.5]{Images/UserSchedule}}
...
\subsection{Functional Requirements}
	...
	\begin{enumerate}[resume, label={[R\arabic*]}]
		...
		\item \mylabel{R-choosen-update}{if a travel plan has already been chosen but some complications (bad weather, traffic, strikes) have arisen the User is informed and a new feasible solution is suggested}
	\end{enumerate}
