...
\subsection{UML modeling}
	In this section we formalize the \defined{S2B} in terms of UML models.\newline
...
\subsection{Functional Requirements}
	...
	\begin{enumerate}[label={[R\arabic*]}]
		...
		\item \mylabel{R-display-right-language}{the app communicate to the user with the language set, if the language is one of the \defined{supported languages}, English otherwise}
	\end{enumerate}
	\begin{itemize}
...
\subsection{Design Constraints}
	...
	\subsubsection{Hardware limitations}
		...
		* Space for app package
		% TODO pier what? This are Software "limitations"
		%\item Web App:\newline
