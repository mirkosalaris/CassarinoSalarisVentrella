...
\subsection{User characteristics}
	\subsubsection{Actors}
			...
			\item Google Maps: the system with whom the S2B retrieves the maps and related information about routes, real-time traffic situations and estimated travel time;
