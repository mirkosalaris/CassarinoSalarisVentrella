...
\paragraph{Goal G8: a User should be able to locate the nearest vehicle of a vehicle sharing system, if that is the transportation mean of choice of an \defined{incoming appointment}}
	\requirements{R32}
	Components:
	\begin{itemize}[label=--]
...
\paragraph{Goal G9: a User should be able to rent a shared vehicle, if that is the transportation mean of choice of an \defined{incoming appointment}}
...
\paragraph{Goal G10: a User should always be aware of the \defined{incoming appointments} and how to reach them}
